      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {featuredStories.length > 0 ? (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16">
                ...
                <div className="lg:col-span-8">
                    <div className="inline-flex items-center gap-2 mb-3 w-fit">
                        <h2 className="text-lg font-bold text-[#e6f1ff] flex items-center gap-2 italic">
                            <Hash size={20} className="text-[#64ffda]" /> Featured
                        </h2>
                    </div>
                        ...
                        {featuredStories.map((story, index) => (
                            <div key={story._id} className={`absolute inset-0 transition-all duration-700 ease-in-out ${index === currentSlide ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                                <Link href={`/news/${story.slug}`} className="block w-full h-full relative cursor-pointer">
                                    <img 
                                        src={story.imageUrl || "https://placehold.co/800x600?text=No+Image"} 
            ...
            <div className="flex flex-col items-center justify-center py-20 opacity-50">
                ...
                <h3 className="text-xl font-bold">No Featured News Found</h3>
            </div>
        )}
