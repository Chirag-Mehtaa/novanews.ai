...
import { 
  ...
  Facebook, Twitter, Linkedin, Loader2, Tag,
...
export default function ArticleView({ slug }) {
  ...
  // 1. Fetch Article Data (Fixed Logic)
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Hum '/api/admin/news' se sab leke filter karenge (Kyuki specific ID API nahi banayi abhi)
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-[#0A192F] text-[#64FFDA]"><Loader2 size={40} className="animate-spin" /></div>;
    ...
    <div className="min-h-screen bg-[#0A192F] text-[#E6F1FF] pt-24 pb-20 font-sans relative selection:bg-[#64FFDA]/30">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        <header className="mb-10">
            ...
            {/* AI Summary Box (Only if summary exists) */}
            {article.summary && (
                <div className="mb-8">
        ...
        {/* ✅ MAIN CONTENT (Updated logic for TinyMCE HTML) */}
        <div 
        ...
        {/* ✅ FIXED TAGS LOGIC (String to Array) */}
        {article.tags && (
